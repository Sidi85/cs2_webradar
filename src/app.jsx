...
const PUBLIC_IP = window.location.hostname || "your ip goes here".trim();
const PORT = 10000;

const EFFECTIVE_IP = USE_LOCALHOST ? "localhost" : PUBLIC_IP;
const CURRENT_PROTOCOL = window.location.protocol === "https:" ? "wss" : "ws";
